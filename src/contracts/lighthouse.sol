// NOTE: this contract is here for viewing only and was authored by Rhombus. 
// Actual compilation of this contract to generate lighthouse.json was  done manually and is outside the scope of this example. 
